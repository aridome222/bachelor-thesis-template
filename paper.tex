...
\begin{thebibliography}{0}
    ...
    \bibitem{NumPy}NumPy: "NumPy"\\\url{https://numpy.org/ja/}\\アクセス日: 2023/02/01.
    
    % \bibitem{膨張処理}マクセルフロンティア株式会社: "2値画像の膨張・収縮①"\\\url{https://www.frontier.maxell.co.jp/blog/posts/21.html}\\アクセス日: 2023/02/01.
    
    \bibitem{BeautifulSoup}Selenium WebDriver: "WebDriver"\\\url{https://beautiful-soup-4.readthedocs.io/en/latest/}\\アクセス日: 2023/01/25.
    \bibitem{difflib}Selenium WebDriver: "WebDriver"\\\url{https://docs.python.org/ja/3/library/difflib.html}\\アクセス日: 2023/01/25.
    ...
    % \bibitem{Flask}Flask Documentation (3.0.x): "Welcome to Flask"\\\url{https://flask.palletsprojects.com/en/3.0.x/}\\アクセス日: 2023/01/25. 
    \bibitem{Flask}Python Tutorial: "What is Flask Pytho"\\\url{https://pythonbasics.org/what-is-flask-python/#What-is-a-Web-Framework}\\アクセス日: 2023/01/25. 
    \bibitem{Werkzeug}Werkzeug Documentation (3.0.x): "Werkzeug"\\\url{https://werkzeug.palletsprojects.com/en/3.0.x/}\\アクセス日: 2023/01/25. 
    \bibitem{Jinja}Jinja Documentation (3.1.x): "Jinja"\\\url{https://jinja.palletsprojects.com/en/3.1.x/}\\アクセス日: 2023/01/25. 
    \bibitem{WSGI}WSGI.org: "What is WSGI?"\\\url{https://wsgi.readthedocs.io/en/latest/what.html}\\アクセス日: 2023/01/25. 
    % \bibitem{Docker}Docker Docs: "Docker overview"\\\url{https://docs.docker.com/get-started/overview/}\\アクセス日: 2023/01/25. 
    \bibitem{Docker Container}Docker: "What is a Container?"\\\url{https://www.docker.com/resources/what-container//}\\アクセス日: 2023/01/25. 
    \bibitem{Docker Compose}Docker Docs: "Docker Compose overview"\\\url{https://docs.docker.com/compose/}\\アクセス日: 2023/01/25. 
